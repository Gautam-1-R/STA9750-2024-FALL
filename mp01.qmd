...
\`\`\`{r} \# Load the tidyverse library library(tidyverse)

# Check if the fare revenue file exists, if not, download it

if(!file.exists("2022_fare_revenue.xlsx")){

download.file("<http://www.transit.dot.gov/sites/fta.dot.go> v/files/2024-04/2022%20Fare%20Revenue.xlsx",
...
filter(`Expense Type` == "Funds Earned During Period") %\>% select(-`Expense Type`)

# Next, expenses

if(!file.exists("2022_expenses.csv")){

\# This should work *in theory* but in practice it's still a bit finicky
...
download.file("[https://data.transportation.gov/api/views/dkxx-zjd6/rows.csv?date=20231102&accessType=DOWNLOAD&bom=true&format=true",](https://data.transportation.gov/api/views/dkxx-zjd6/rows.csv?date=20231102&accessType=DOWNLOAD&bom=true&format=true%22,)
...
\# browser and save it as "ridership.xlsx" in your project \# directory.

download.file("[https://www.transit.dot.gov/sites/fta.dot.gov/files/2024-09/July%202024%20Complete%20Monthly%20Ridership%20%28with%20adjustments%20and%20estimates%29_240903.xlsx",](https://www.transit.dot.gov/sites/fta.dot.gov/files/2024-09/July%202024%20Complete%20Monthly%20Ridership%20%28with%20adjustments%20and%20estimates%29_240903.xlsx%22,) destfile="ridership.xlsx", quiet=FALSE, method="wget") }
...
summarize(total_UPT = sum(UPT, na.rm = TRUE)) %\>% arrange(month)
...
USAGE_AND_FINANCIALS \<- left_join(USAGE_2022_ANNUAL, FINANCIAL by = c("NTD ID", "Mode")) %\>%
